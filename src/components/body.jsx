                    ...
                    <div className="section-inner">
                        ...
                        <div className="content">    
                            ...
                            <div className="item row">
                                ...
                                <img className="img-responsive project-image" src="./src/assets/images/projects/project-4.png" alt="project name" />
                                </a>
                                <div className="desc col-md-8 col-sm-8 col-xs-12">
                                    <h3 className="title"><a href="" target="_blank">Velocity - Designed for Products</a></h3>
                                    ...
                                    <p><a className="more-link" href="" target="_blank"><i className="fa fa-external-link"></i> Find out more</a></p>
                                </div>                       
                            </div>
                            
                            <div className="item row">
                                <a className="col-md-4 col-sm-4 col-xs-12" href="" target="_blank">
                                <img className="img-responsive project-image" src="./src/assets/images/projects/project-1.png" alt="project name" />
                                </a>
                                <div className="desc col-md-8 col-sm-8 col-xs-12">
                                    <h3 className="title"><a href="" target="_blank">Tempo - Designed for Startups</a></h3>
                                    <p>You can put one of your secondary projects here. Suspendisse in tellus dolor. Vivamus a tortor eu turpis pharetra consequat quis non metus. Aliquam aliquam, orci eu suscipit pellentesque, mauris dui tincidunt enim, eget iaculis ante dolor non turpis.</p>
                                    <p><a className="more-link" href="" target="_blank"><i className="fa fa-external-link"></i> Find out more</a></p>
                                </div>                       
                            </div>
                            ...
                            <div className="item row">
                                <a className="col-md-4 col-sm-4 col-xs-12" href="" target="_blank">
                                <img className="img-responsive project-image" src="./src/assets/images/projects/project-2.png" alt="project name" />
                                </a>
                                <div className="desc col-md-8 col-sm-8 col-xs-12">
                                    <h3 className="title"><a href="" target="_blank">Delta - Designed for Mobile Apps</a></h3>
                ...
                <section className="projects section">
                    <div className="section-inner">
                        ...
                        <div className="content">
                            ...
                            <div className="item">
                                <h3 className="title"><a href="#">Project Title Cras eget lacus</a> <span className="label label-theme">Open Source</span></h3>
                                ...
                                <p><a className="more-link" href="" target="_blank"><i className="fa fa-external-link"></i> View on GitHub</a></p>
                            </div>
                            <div className="item">
                                <h3 className="title"><a href="#">Project Title Maecenas Ornare</a> <span className="label label-theme">Open Source</span></h3>
            ...
            <div className="secondary col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div className="section-inner">
                        ...
                        <div className="content">
                            ...
                            <div className="skillset">
                                ...
                                <div className="item">
                                    <h3 className="level-title">Python &amp; Django<span className="level-label" data-toggle="tooltip" data-placement="left" data-animation="true" title="You can use the tooltip to add more info...">Expert</span></h3>
                ...
                <aside className="list conferences aside section">
                    <div className="section-inner">
                        ...
                        <div className="content">
                            <ul className="list-unstyled">
                                <li><i className="fa fa-calendar"></i> <a href="" target="_blank">WWDC 2014</a> (San Francisco)</li>
                                <li><i className="fa fa-calendar"></i> <a href="">Hive</a> (Seattle)</li>
                            </ul>
                        </div>
                    </div>
                </aside>
